"use strict";
var
	wsServer = new ( require( 'ws' ) ).Server( { port: 1234 } ),
	http = require( 'http' ),
	url = require( 'url' ),
	fs = require( 'fs' ),
	logWs = {},
...
console.log( 'Begin listening :800' );

wsServer.on( 'connection', function ( ws ) {
	var up = url.parse( ws.upgradeReq.url, true ),
		devID = up.query.devID, role = up.path.split( '/' )[ 1 ] || 'listen';
...
console.log( 'Begin listening :8100' );